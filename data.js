...
const SITE = {
  ...
  kajian: {
    ...
    daftar: [
      ...
      {
        nama: "Logika kritis",
        isi: "Melacak kekeliruan yang lolos dari perhatian karena bentuknya terlihat masuk akal. Kesesatan semacam itu letaknya bukan di kesimpulan, melainkan di pijakan yang tidak pernah diperiksa.",
      },
    ],
  },
  ...
  karya: {
    ...
    daftar: [
      ...
      },
      {
        ...
        penerbit: "Zenodo",
        ringkasan:
          "Kehidupan sosial hari ini makin ditandai oleh hubungan yang berbentuk transaksi. Esai ini mencari kemungkinan kebersamaan yang intens tanpa tuntutan, yaitu kedekatan yang tidak menagih apa pun untuk membenarkan dirinya.",
        tautan: "",
        unggulan: false,
      },
      {
  ...
  perjalanan: {
    ...
    daftar: [
      ...
      },
      {
        ...
        isi: "Artikel tentang fungsi kesekretariatan gereja terbit di jurnal Didasko. Itu pengalaman pertama menyusun argumen untuk pembaca di luar ruang kelas.",
      },
      {
        tahun: "2025",
  ...
  /* --- 11. TOMBOL MASUK ---------------------------------------------------- */
  /* Tombol di kanan atas yang membuka panel penyuntingan setelah sandi benar. */
  /* Sandi awal: krb2026 — ganti lewat tombol "Ganti sandi" di dalam panel.    */
  /* Yang tersimpan di bawah bukan sandinya, melainkan sidik jarinya.          */
  masuk: {
    aktif: true,
    label: "Masuk",
    labelSudah: "Sunting",
    sandi: "cc78eb9384ad79a9f5910670f9b2001d8da3ecb8dd77c9da05cfa2c7febb4160",
  },
